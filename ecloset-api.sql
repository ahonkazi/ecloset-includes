...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2023 at 11:21 AM
...
(83, '2023_10_30_122656_add_order_status_orders_table', 60),
(86, '2023_10_30_150332_create_product_reviews_table', 61);
...
CREATE TABLE `orders` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `order_status` varchar(255) NOT NULL COMMENT 'Delivered,Pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `orders` (`id`, `unique_id`, `customer_id`, `shipping_id`, `payment_method`, `total_price`, `created_at`, `updated_at`, `order_status`) VALUES
(19, 741476, 23, 20, 1, 17400, '2023-10-30 07:41:03', '2023-10-30 10:08:49', 'Delivered');
...
INSERT INTO `order_items` (`id`, `customer_id`, `order_id`, `product_id`, `combination`, `quantity`, `coupon_code`, `created_at`, `updated_at`) VALUES
(22, 23, 19, 4, '150 gm + Green', 200, NULL, '2023-10-30 07:41:03', '2023-10-30 07:41:03');
...
INSERT INTO `product_reviews` (`id`, `customer_id`, `product_id`, `rating`, `message`, `recomended`, `created_at`, `updated_at`) VALUES
(1, 23, 4, 5, 'Wow,,this product is so awesome.I need more of this', 1, '2023-10-30 10:08:59', '2023-10-30 10:19:04');
...
(7, 4, 22, 58, 60, 87, 0.00, 500, '2023-10-22 05:04:37', '2023-10-30 07:41:03'),
...
(20, 23, 'Ahon', 'khan', 'Bangladesh', 'Rangpur', 'Peerganj', 'Bhendabari khalaspir road', '803', '5202', '+8801313386702', '2023-10-30 07:41:03', '2023-10-30 07:41:03');
